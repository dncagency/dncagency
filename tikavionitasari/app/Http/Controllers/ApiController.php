...
class ApiController extends Controller
{
    ...
    public function pengajuan_ijinusaha(Request $request)
    {
        $validator = Validator::make(
            $request->all(),
            [
            ...
            [
                ...
                'status' => 'Harus Ada Status Perkawinan',
                'pekerjaan' => 'Harus Ada Pekerjaan',
                'namausaha' => 'Harus Ada Nama Usaha',
                'alamat' => 'Harus Ada Alamat',
                'keterangan' => 'Harus Ada',
            ]
        );
        if ($validator->fails()) {
            ...
            if ($data) {
                return response()->json([
                    'success' => true,
                    'message' => 'Pengajuan ijin usaha berhasil dikirim!',
                    'data'    => $data,
                ], 200);
            } else {
                return response()->json([
                    'success' => false,
                    'message' => 'Pengajuan ijin usaha gagal dikirim!',
                ], 401);
            }
        }
    }
