...
use App\Http\Controllers\IjinusahaController;
...
Route::group(['middleware' => 'can:isAdmin'], function ($id = null) {
    ...
    Route::get('/ijinusaha', [IjinusahaController::class, 'pengajuanijinusaha'])->name('ijinusaha');
    Route::get('/detailijinusaha/{id}', [IjinusahaController::class, 'detailijinusaha'])->name('detailijinusaha', $id);
    Route::post('/uploadijinusaha/{id}', [IjinusahaController::class, 'uploadijinusaha'])->name('uploadijinusaha', $id);
    Route::get('/accijinusaha/{id}', [IjinusahaController::class, 'accijinusaha'])->name('accijinusaha', $id);
});
...
Route::group(['prefix' => 'masyarakat', 'middleware' => 'can:isUser'], function ($id = null) {
    ...
    Route::get('/pengajuanijinusaha', [IjinusahaController::class, 'pengajuanijinusaha'])->name('pengajuanijinusaha');
    Route::get('/tambahijinusaha', [IjinusahaController::class, 'tambahijinusaha'])->name('tambahijinusaha');
    Route::post('/insertijinusaha', [IjinusahaController::class, 'insertijinusaha'])->name('insertijinusaha');
    Route::get('/downloadijinusaha/{id}', [IjinusahaController::class, 'downloadijinusaha'])->name('downloadijinusaha', $id);
});
