                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a class="btn btn-outline-success" href="{{ route('tambahsktm') }}" role="button"><svg
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <a class="btn btn-success"
                                                                href="{{ route('downloadsktm', $row->id) }}"
                                                        ...
                                                        <div class="btn-group dropleft">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('detailsktm', $row->id) }}">Detail</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('accsktm', $row->id) }}">Acc</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
