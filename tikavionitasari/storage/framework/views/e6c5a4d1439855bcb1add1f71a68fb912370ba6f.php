                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a class="btn btn-outline-success" href="<?php echo e(route('tambahslipgaji')); ?>"
                                    ...
                                    <table class="table mt-4">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <th scope="row"><?php echo e($nom++); ?></th>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php else: ?>
                                                            <a class="btn btn-success"
                                                                href="<?php echo e(route('downloadslipgaji', $row->id)); ?>"
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if(session('upload')): ?>
                                        <div class="alert alert-success mt-4">
                                            <?php echo e(session('upload')); ?>

                                        </div>
                                    <?php elseif(session('acc')): ?>
                                        <div class="alert alert-success mt-4">
                                            <?php echo e(session('acc')); ?>
                                                        ...
                                                        <div class="btn-group dropleft">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('detailslipgaji', $row->id)); ?>">Detail</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('accslipgaji', $row->id)); ?>">Acc</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\said-master\resources\views/User/pengajuanslipgaji.blade.php ENDPATH**/ ?>