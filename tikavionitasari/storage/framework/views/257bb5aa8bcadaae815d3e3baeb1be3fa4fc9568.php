                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a class="btn btn-outline-success" href="<?php echo e(route('tambahinformasi')); ?>"
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td class="card-text"><?php echo Str::limit($row->judul, 25); ?></td>

                                                    <td>
                                                        <img src="<?php echo e(asset('gambarinformasi/' . $row->gambar)); ?>" alt=""
                                                            style="width:100px">
                                                    </td>
                                                    <td class="card-text"><?php echo Str::limit($row->isi, 35); ?></td>
                                                    <td>
                                                        <div class="btn-group dropleft">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('editinformasi', $row->id)); ?>">Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('deleteinformasi', $row->id)); ?>">Hapus</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-5">
                                                                ...
                                                                <img class="card-img-top"
                                                                    src="<?php echo e(asset('gambarinformasi/' . $row->gambar)); ?>"
                                                                    alt="Title">
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <h5 class="card-title"><?php echo e($row->judul); ?></h5>
                                                                <p class="card-text"><?php echo Str::limit($row->isi, 250); ?>

                                                                </p>
                                                                <a href="<?php echo e(route('detailinformasi', $row->id)); ?>"
                                                                    class="btn btn-primary">
                                                                    Selengkapnya.
                                                                </a>
                                                                <p class="card-text">Diubah pada :
                                                                    <?php echo e($row->updated_at); ?>.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\said-master\resources\views/Dashboard/informasi.blade.php ENDPATH**/ ?>