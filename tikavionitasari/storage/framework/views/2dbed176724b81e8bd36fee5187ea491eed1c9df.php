                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a class="btn btn-outline-success" href="<?php echo e(route('tambahsktm')); ?>" role="button"><svg
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php else: ?>
                                                            <a class="btn btn-success"
                                                                href="<?php echo e(route('downloadsktm', $row->id)); ?>"
                                                        ...
                                                        <div class="btn-group dropleft">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('detailsktm', $row->id)); ?>">Detail</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('accsktm', $row->id)); ?>">Acc</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\said-master\resources\views/User/pengajuansktm.blade.php ENDPATH**/ ?>